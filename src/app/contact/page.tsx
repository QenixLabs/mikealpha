    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {cards.map(card => (
              <div key={card.title} className="bg-white rounded-2xl shadow-card p-6 text-center group hover:-translate-y-1 transition-all duration-300 border border-[#E5E5E0] hover:border-coral/20"
              >
          ...
          >
            ...
            >
              <div>
                ...
                <h3 className="text-2xl font-bold text-navy font-heading mb-3"
                >Where It All Comes Together</h3>
                ...
                >State-of-the-art facility with strict quality control.</p>
              </div>
