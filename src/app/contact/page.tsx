...
export default function Contact() {
  ...
  const cards = [
    { icon: <Phone className="w-6 h-6" />, title: "Call Us", info: "+91 87992 90971" },
    { icon: <Mail className="w-6 h-6" />, title: "Mail Us", info: "mikealphaagro@gmail.com" },
    { icon: <MapPin className="w-6 h-6" />, title: "Office", info: "C-304, Vivaan Elementos, SP Ring Road, Gandhinagar, Gujarat 382421" },
    { icon: <Clock className="w-6 h-6" />, title: "Hours", info: "Mon–Fri: 9AM–6PM" },
  ]
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative z-10 -mt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {cards.map(card => (
              <div key={card.title} className="bg-white rounded-2xl shadow-card p-6 text-center group hover:-translate-y-1 transition-all duration-300 border border-[#E5E5E0]">
                <div className="inline-flex items-center justify-center w-14 h-14 bg-coral-subtle rounded-2xl text-coral mb-4 group-hover:scale-110 transition-transform">
                  {card.icon}
                </div>
                <h4 className="font-semibold text-navy mb-1">{card.title}</h4>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[3px] text-coral mb-4">Let&apos;s Connect</p>
              <h2 className="text-section font-bold text-navy font-heading mb-6">
                Send us your message
              </h2>
              <p className="text-[#6B6B6B] leading-relaxed max-w-md mb-8">
            ...
            <div>
              {submitted ? (
                <div className="bg-[#FAFAF8] rounded-2xl p-12 text-center border border-[#E5E5E0]">
                ...
                <form onSubmit={handleSubmit} className="bg-[#FAFAF8] rounded-2xl p-6 lg:p-8 border border-[#E5E5E0] space-y-5">
                  ...
                  <button type="submit" className="w-full bg-coral hover:bg-coral-dark text-white font-semibold py-4 rounded-xl transition-all flex items-center justify-center gap-2 hover:shadow-lg">
      ...
      <section className="bg-[#FAFAF8] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="bg-white rounded-2xl p-8 lg:p-10 border border-[#E5E5E0]">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[3px] text-coral mb-3">Manufacturing</p>
